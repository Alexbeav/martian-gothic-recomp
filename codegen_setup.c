...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Martian Gothic",
    .project_root_env = "MARTIAN_GOTHIC_PROJECT_ROOT",
    .build_dir_env = "MARTIAN_GOTHIC_BUILD_DIR",
    .force_setup_env = "MARTIAN_GOTHIC_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLES_013.50_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Martian_Gothic_Recompiled",
    .prepare_note =
